...
export const POSTS: Post[] = [
  {
    ...
    body: [
      ...
      "My hypothesis is that sufficiently good initial embeddings may leave less room for an additional learned transformation to help. That transformation could introduce distortion or optimisation difficulties without improving retrieval. But the ablation doesn’t establish this explanation: it shows which quantiser worked better in this setting, not that RQ-VAE inherently “adds noise.”",
